...
Config.Strings = {
	ExitVehicle = "Gå af/ud af køretøjet for at tanke.",
	EToRefuel = "Start ~g~E ~w~tanking",
	JerryCanEmpty = "benzin dunk er fald",
	FullTank = "Bilen er helt tanked",
	PurchaseJerryCan = "Tag ~g~E ~w~for at købe benzin tank ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Tryk ~g~E ~w~igen for at stoppe",
	CancelFuelingJerryCan = "Tryk ~g~E ~w~for at stoppe tanking",
	NotEnoughCash = "Ikke nok penge",
	RefillJerryCan = "Tryk ~g~E ~w~ For at få nyt benzin i din dunk ",
	NotEnoughCashJerryCan = "Du har ikke nok penge til at få mere benzin i dunken",
